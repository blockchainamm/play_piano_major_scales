# Program to generate the sounds of notes of a major scale matching the frequencies of notes in piano
...
def load_notes(notestep, notestep1):
    ...
    # Interval of notes for a major scale
    notes_interval = [2, 2, 1, 2, 2, 2, 1, 1]
    rev_interval = [0, 1, 2, 2, 2, 1, 2, 2]
    tones_fwd, tones_rev = [], []
    ...
    # Return list of frequencies in the ascending and descending notes of the major scale    
...
# Scale list for which the major scale will be played in sequence
